...
public class SelenideTestServicePage extends SelenideBase {
    ...
    public void servicePageInterfaceCheck() {
        ...
        differentElementsPage.checkCheckboxesEnableActionLog(CheckboxesLabels.EARTH);
        differentElementsPage.checkCheckboxesEnableActionLog(CheckboxesLabels.WATER);
        differentElementsPage.checkCheckboxesEnableActionLog(CheckboxesLabels.FIRE);
        differentElementsPage.checkCheckboxesEnableActionLog(CheckboxesLabels.WIND);
        ...
        differentElementsPage.checkCheckboxesDisableActionLog(CheckboxesLabels.WATER);
        differentElementsPage.checkCheckboxesDisableActionLog(CheckboxesLabels.WIND);
